<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Template.aspx.cs" Inherits="informedPatient_prototype.Template" %>
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    
    <h1>Drug Name (medical name)</h1>
    <hr />
    <section><h2><b>General information</b></h2>
        <br />
    <em><strong>Drug</strong> </em>is a common medication that helps cure illness. 
        While Drug2 is a stonger drug to cure illness, Drug is a good choice for those who only have mild forms of Illness.  
        <hr />
    </section>
     <section>
