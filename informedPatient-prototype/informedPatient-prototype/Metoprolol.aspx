...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <section><h2><b>General information</b></h2>
        <br />
    <em><strong></strong>Metoprolol </em>is a common prescription medication that helps treat high blood pressure, chest pain (angina), 
        and heart failure.
        This may lower the risk of death after a heart attack.
        <hr />
    </section>
     <section>
